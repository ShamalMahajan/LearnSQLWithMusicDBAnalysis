-->Q1.Select senior most employee based on job title?
...
-->Q3.what are top 3 values in invoices
SELECT * FROM invoice
Order by total desc
limit 3
...
---return your list ordered alphabetically by emual starting with A.
...
SELECT * FROM popular_genre1 WHERE RowNo <= 1
